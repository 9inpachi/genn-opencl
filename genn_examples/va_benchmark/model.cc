...
void modelDefinition(NNmodel &model)
{
	...
	/*
	GENN_PREFERENCES.workGroupSizeSelectMethod = WorkGroupSizeSelect::MANUAL;
	std::fill(GENN_PREFERENCES.manualWorkGroupSizes.begin(), GENN_PREFERENCES.manualWorkGroupSizes.end(), 256);*/
