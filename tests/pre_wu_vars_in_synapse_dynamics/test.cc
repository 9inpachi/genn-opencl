//--------------------------------------------------------------------------
/*! \file pre_wu_vars_in_synapse_dynamics/test.cc
...
#include "pre_wu_vars_in_synapse_dynamics_CODE/definitions.h"
        ...
        while(t < 200.0f) {
            ...
            if(t > DT) {
                ...
                for(unsigned int i = 0; i < 10; i++) {
                    ...
                    //std::cout << "wsyn[" << i << "] = " << wsyn[i] << std::endl;
                    if(delayedTime < 0.0f) {
...
TEST_F(SimTest, PreWuVarsInSynapseDynamics)
{
    Simulate();
}
